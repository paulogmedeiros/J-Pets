    ...
    <div className="container">
      ...
      <div className="row justify-content-center col-12 ps-4 col-md-8 position-absolute top-50 start-50 translate-middle ">
        ...
        <div className="col-md-5 d-flex-md-5">
          ...
          {/* Título */}
          <p class="tituloNovoProduto fs-1 fw-semibold text-center mb-4 mb-md-5">Novo produto</p>
          ...
          <a class="btnNovoProduto btn w-100" href="#" role="button">Cadastrar produto</a>
