            ...
            <div class="container mt-5">
                <div class="row">
                    ...
                    <div class="admTabelaPrincipal col-9 border border-2 rounded-3 mt-5 text-center">
                        <div className='row '>
                            <p className='d-flex col-4 mt-5  fs-2 fw-semibold'>Todas as marcas</p>
                            <div class="input-group d-flex mb-3 col-4 w-25 me-2 mt-5">
                                <input type="text" class="form-control" placeholder="Pesquisar marca" aria-label="Recipient's username" aria-describedby="basic-addon2" />
                                <span class="input-group-text" id="basic-addon2"><img src={pesquisaIcone_adm} alt="" srcset="" width={20} color='black' /></span>
                            </div>
