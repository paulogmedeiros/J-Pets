  ...
  useEffect(() => {
    ...
    const fetchAnimalData = async () => {
      try {
        ...
        // Encontrando o animal específico (no caso, Peixe)
        const animalPeixe = dataAnimais.find((animal) => animal.nome === 'Peixe');

        // Definindo o animal no estado
        setAnimal(animalPeixe);

        // Buscar produtos do animal específico
        await pegarProdutosPorIdAnimal(animalPeixe.id);

        // Definindo o título da página
        document.title = `Busca de Produtos | ${animalPeixe?.nome}`;
      } catch (error) {
...
export default BuscarProdutoPeixe