...
import './BuscarProdutoCachorro.css';
...
function BuscarProdutosCachorro() {
  ...
  useEffect(() => {
    ...
    const fetchAnimalData = async () => {
      try {
        ...
        // Encontrando o animal específico (no caso, Cachorro)
        const animalCachorro = dataAnimais.find((animal) => animal.nome === 'Cachorro');

        // Definindo o animal no estado
        setAnimal(animalCachorro);

        // Buscar produtos do animal específico
        await pegarProdutosPorIdAnimal(animalCachorro.id);

        // Definindo o título da página
        document.title = `Busca de Produtos | ${animalCachorro?.nome}`;
      } catch (error) {
...
export default BuscarProdutosCachorro;
