    ...
    <div className="container">
      ...
      <div className="row justify-content-center col-12 ps-4 col-md-8 position-absolute top-50 start-50 translate-middle">
        ...
        <div className="col-md-5 d-flex-md-5">
          ...
          <p className="AlterarSenhaDonosPetTitulo fs-1 fw-bold text-center mb-2 mb-md-2 mt-3">Redefinição de senha</p>
          ...
          <a className="btnAlterarSenhaDonosPet btn w-100" href="#" role="button">Confirmar</a>

          <p className="text-body-dark text-center mt-3">
            <a href="#" className="cancelarAlterarSenhaDonosPet link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">Voltar à tela de login</a>
          </p>
        </div>
      </div>
    </div>
