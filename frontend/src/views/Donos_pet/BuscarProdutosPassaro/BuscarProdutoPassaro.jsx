...
import './BuscarProdutoPassaro.css'
  ...
  useEffect(() => {
    ...
    const fetchAnimalData = async () => {
      try {
        ...
        // Encontrando o animal específico (no caso, Pássaro)
        const animalPassaro = dataAnimais.find((animal) => animal.nome === 'Pássaro');

        // Definindo o animal no estado
        setAnimal(animalPassaro);

        // Buscar produtos do animal específico
        await pegarProdutosPorIdAnimal(animalPassaro.id);

        // Definindo o título da página
        document.title = `Busca de Produtos | ${animalPassaro?.nome}`;
      } catch (error) {
...
export default BuscarProdutoPassaro